...
export default class PspFinalizeComponent extends Component {
	constructor() {
		super();
	...
	render() {
		...
		return (
			<div className="content-block">
				...
				<p>
					Die Änderung an Ihrer Zahlungsart wurde erfolgreich übernommen!
				</p>
			</div>
		)
	}
...
if (document.getElementById('psp-finalize')) {
	ReactDOM.render(<PspFinalizeComponent/>, document.getElementById('psp-finalize'));
}
